...
**La diferencia entre tamaños de picos entre las especies Barbijo y Papúa con Adelia es significativa, sin embargo entre estas dos ultimas la diferencia es mínima. Se puede observar que en cambio entre machos y hembras, el macho tiene el pico mas largo. La línea de regresión lineal ayuda a entender la relación entre la anchura y la longitud del pico para cada especie/isla **
